...
app.get('/board', async(req, res) => {
    var usersData = (await pool.query(`select level, player_score, player.name from player_exercise, player where player.id = player_exercise.player_id order by player_score asc`)).rows;
    res.json({
        data: usersData
    })
});
